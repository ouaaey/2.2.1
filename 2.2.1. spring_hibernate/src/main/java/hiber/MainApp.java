...
public class MainApp {
    public static void main(String[] args) throws SQLException {
        ...
        User UserByCar = userService.getUserByCar("model4", 789);
        if (UserByCar != null) {
            System.out.println("User found: " + UserByCar.getId() + UserByCar.getFirstName() + UserByCar.getLastName()
                    + UserByCar.getEmail());
            if (UserByCar.getCar() != null) {
                System.out.println("Car model found: " + UserByCar.getCar().getModel());
                System.out.println("Car series found: " + UserByCar.getCar().getSeries());
            }
        }
